...
<ul>
    ...
    <li><a id="nav-cont" class="tip" title="Модуль контент-анализа">Контент-анализ</a></li>
    <li><a id="nav-disc" class="tip active" title="Модуль дискурс-анализа">Дискурс-анализ</a></li>
